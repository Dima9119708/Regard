...
export class Content extends ParentComponent {
  ...
  prepare() {
    this.sideBar = new Sidebar(this.$root, this.DATA)
    this.search = new Search(this.$root, this.DATA)
  }
